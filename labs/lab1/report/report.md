...
![Графики $y_1=\sin{x}+\frac{1}{3}\sin{3x}+\frac{1}{5}\sin{5x}$ и $y_2=\cos{x}+\frac{1}{3}\cos{3x}+\frac{1}{5}\cos{5x}$](image/plot-sin1.png){#fig:002 width=70%}
...
![График двух синусоидальных сигналов разной частоты при fd = 128.](image/spectre_sin12.png){#fig:009 width=70%}

![Откорректированнвй график спектров синусоидальных сигналов при fd = 128.](image/spectre_fix12.png){#fig:010 width=70%}

![График суммарного сигнала при fd = 128.](image/spectre_sum_sin12.png){#fig:011 width=70%}

![График спектра суммарного сигнала при fd = 128.](image/spectre_sum12.png){#fig:012 width=70%}
